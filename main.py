...
if MathChoise:
    DiffSet = int(input('The difficulty of for this practice ranges from 1 to 5, \n1 is the the easiest and 5 being the hardest, the harder the difficulty, the more amount of questions you will have to answer as well rhe questions will become even harder!  \nPlease select a difficulty by typing a number:'))
